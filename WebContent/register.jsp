	...
	<form name="form1" method="post" action="register.aspx" id="form1">
		...
		<div class="p167-permit" style="margin-bottom: 0; position: relative;">
			...
			<div class="p167-permit-form1">
				...
				<input name="txtUser" maxlength="11" id="txtUser"
					class="p167-permit-phone " placeholder="请输入手机号" type="text">

				<input name="txtUserNane" id="txtUserName"
					class="p167-permit-phone " placeholder="请输入昵称" type="text">

				<input name="txtPwd" maxlength="20" id="txtPwd" class="pwdReg"
					placeholder="请输入至少6位密码" type="password"> <input
					name="txtPwd" maxlength="20" id="txtPwd" class="pwdReg"
					placeholder="请再次输入密码" type="password">

				<!-- 验证码 -->
				<div id="trVCode" class="p167-permit-phone"
					style="border-bottom: 1px solid #ebebeb;">
					<table>
						<tbody>
							<tr>
								<td style="width: 240px;"><input name="txtVCode"
									maxlength="5" id="txtVCode" class="vcodeInput  vcodeInput-n "
									placeholder="请输入验证码" style="width: 100px;" type="text">
								</td>
								<td><span class="captcha-img"> <img id="Image1"
										class="x-vcode-img" onclick="RefreshImage()" title="看不清楚？换张图片"
										src="${pageContext.request.contextPath}/images/ValidateCode.jpg"
										style="border-width: 0px; cursor: pointer; vertical-align: top; width: 68px; height: 40px;"
										align="middle">
								</span></td>
							</tr>
						</tbody>
			...
			<a id="btnLogin" href="#" class="p167-bind-btn">注册</a>
			<!-- 	注册成功 三秒后跳转到登陆页面 -->
...
.p167-passportleft {
	...
	margin-right: 10px;
		...
		<!-- 	<div style="display: none;">
			...
			<input name="btnSendSmsCode" id="btnSendSmsCode" value="获取短信码"
				type="button">
		</div> -->
