	...
	$('#haha').jqPaginator({
	    ...
	    onPageChange: function (num, type) {
	      ...
	      if(ok){
	    	 ...
	    	 window.location.href="${pageContext.request.contextPath}/zbwfindWeekExamQuestion.do?pages="+num+"&id="+${param.id};
	      }
...
<body>
 <div class="wrap">
  <div class="page-title">
    <span class="modular fl"><i></i><em>编辑周测试卷</em></span>
    <span class="modular fr"><a href="${pageContext.request.contextPath}/zbwselectquestion.do?id=${id}&subject=${subject}" class="pt-link-btn">+添加试题</a></span>
  </div>
  <div class="operate">
  	<span>
 		试卷编号：${id}
  ...
  <table class="list-style Interlaced">
   ...
   <c:forEach items="${week_Exam_Question_List_vos}" var="w">
   <tr>
    <td>
  ...
  <div style="overflow:hidden;">
	  ...
	  <div class="BatchOperation fl">
	   ...
	   <input  type="button" value="保存"  class="btnStyle" onclick="window.location.href='${pageContext.request.contextPath}/product_category_week.jsp'"/>
 	<a  href="product_category_week.jsp"><input  type="button" value="返回" class="btnStyle" /></a>
