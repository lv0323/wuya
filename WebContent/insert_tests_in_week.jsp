	...
	$('#haha').jqPaginator({
	    ...
	    onPageChange: function (num, type) {
	      ...
	      if(ok){
	    	 ...
	    	 window.location.href="${pageContext.request.contextPath}/zbwselectquestion.do?pages="+num+"&id=${weekExamId}&subject=${subject}";
	      }
...
function clearall() {
	...
	$(":checkbox:checked").each(function() {
		...
		//发起ajax删除一条试题内容
		$.ajax({
				url:"/WuYa/zbwinsertWeekExamQuestion.do",
				type:"get",
				data:"questionId="+i+"&weekId="+${weekExamId},
				dataType:"json",
				success:function(data){
					window.location.href="${pageContext.request.contextPath}/zbwfindWeekExamQuestion.do?id="+${weekExamId};
				}
			 });
		//删除前端页面此条消息
 ...
 <div class="wrap">
  ...
  <div style="overflow:hidden;">
	  ...
	  <div class="BatchOperation fl">
	   ...
	   <a  href="zbwfindWeekExamQuestion.do?id=${weekExamId}"><input  type="button" value="返回" class="btnStyle"/></a>
	  </div>
	  <!-- turn page -->
