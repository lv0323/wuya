...
<body>
	<form method="post" action="${pageContext.request.contextPath}/Managerchangepass.do" id="form1">
					...
					<div class="p116-info-item">
						...
						<div class="mInputBlock">
							<input name="login_name" id="login_name" placeholder=""
								class="mSelectInput" type="text" value="<%=request.getSession().getAttribute("managername")%>" disabled="disabled">
