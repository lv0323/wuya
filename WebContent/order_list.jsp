...
<body>
 <div class="wrap">
  <div class="page-title">
    <span class="modular fl"><i class="order"></i><em>查看试题</em></span>
  </div>
  <div class="operate">
   <form>
  ...
  <table class="list-style Interlaced">
   ...
   <tr>
    <td>
     <input type="checkbox"/>
     <a href="order_detail.jsp">2015041803225</a>
    </td>
    <td class="center">
    ...
    <td class="center">
     <a href="order_detail.jsp" class="inline-block" title="查看订单"><img src="images/icon_view.gif"/></a>
