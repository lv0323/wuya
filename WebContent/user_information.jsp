...
<body>
	<form id="form1" method="post" action="${pageContext.request.contextPath}/changeInfo.do"> 
		<!--riaHtmlStart-->
				...
				<div class="p116-info">
					...
					<div class="p116-info-item information_container">
						...
						<div class="p116-info-item">
							...
							<div class="mInputBlock">
								...
								<input name="login_name" id="login_name" 
									class="form-control update_info" value="<%=request.getSession().getAttribute("username")%>" type="text" disabled="disabled" >
							</div>
						</div>
						<div class="form-group">
							...
							<div class="mInputBlock">
								<div class="show_info"></div>
								<input name="email" id="inputError" placeholder=""
						...
						<div class="form-group">
							...
							<div class="control-group update_info"
								...
								<div class="controls" style="display: inline-block;">
									<input name="city" id="inputError" placeholder=""
									class="form-control update_info" type="text">
								</div>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="mInputBlock">
								<div class="show_info"></div>
								<input name="tell" id="inputError" placeholder=""
									class="form-control update_info" type="text">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="mInputBlock">
								<div class="show_info"></div>
								<input name="job" id="inputError" placeholder=""
									class="form-control update_info" type="text">
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="mInputBlock">
								<div class="show_info"> </div>
								<input name="address" id="inputError" placeholder=""
									class="form-control update_info" type="text">
							</div>
						</div>
						...
						<div class="p116-info-item p116-margin-top">
							...
							<div class="mInputBlock">
								<input name="btn_first" value="确认提交信息" id="btn_first"
									class="ButtonBlue update_info" type="submit">
							</div>
						</div>
