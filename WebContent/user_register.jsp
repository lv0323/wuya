...
<body style="min-height: 800px;">
	<form name="regist_form" method="post" action="register.do" id="form">
		<div>
		...
		<div class="p167-nav">
			<div class="PublicHeaderWrap">
				<div class="PublicHeader">
					...
					<span class="p167-nav-in-right"><a href="common_login.jsp" class="toplink1">登录</a><span
						class="p167-nav-in-right-s">|</span><a href="home_index.jsp"
