			...
			<div class="nr_left">
				<div class="test">
					...
					<% 
					 ...
					 request.getSession().setAttribute("qweek_exam_id", we.getWeek_exam_id());
					%>
						<div class="test_title">
							...
							<div class="test_content">
								<div class="test_content_title">
									...
									<p>
										<span>共</span><i class="content_lit"><%=list.size() %></i><span>题，</span><span>合计</span><i class="content_fs"></i><span><%=we.getTatal_points() %>分</span>
									</p>
								</div>
							</div>
