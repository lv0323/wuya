...
$(document).ready(function () {
	...
	// Generating slides
	var arrCities = ['Specific', 'Measurable', 'Attainable', 'Relevant', 'Time-bound']; // Change number of slides in CSS also
	...
	$(".first_menu").on('click','.layui-btn',function() {
		$(".first_menu button").css("background-color","#FFF");
		$(this).css("background-color","#5DC9C9");
