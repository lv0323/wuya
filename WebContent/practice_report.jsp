		...
		<div class="w1000 cf">
			...
			<div class="wl">
				...
				<div class="analysis">
					...
					<p class="para">你于 <span class="cr">${time}</span>参加无涯测评的 <span class="cr">刷题测试</span>，得分<span class="cr">${user_score}</span>分/满分${total_score}。以下是对测评情况的详细分析。</p>
					<p class="para">你的<span class="cr"></span>测评能力位处<span class="cr">等级${rank }</span>。</p>
					<div class="cf">
						<div class="w380 l" style="margin:0 auto;">
							<table border="0" cellspacing="0" cellpadding="0" class="tbl">
								...
								<c:forEach items="${vo}" var="v" >
									<tr>
										<td title="Listening ">${v.knowlege_name }</td>
										<td>${v.right}/${v.total_question }</td>
										<td>${v.user_score}/${v.total_socre}</td>
									</tr>
								</c:forEach>	
							</table>
						</div>
